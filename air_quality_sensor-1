  ...
  local function collectData()
    http:request(url, {
        ...
        success = function(response)
          ...
          data.humidityabsolute = self:getHumidityAbs(data.humidity,data.temperature,data.pressure) -- Calculate Absolute Humidity
          ...
          data.labelText = data.labelText .."Absolute Humidity: " ..data.humidityabsolute .." g/m³" .."\n" 
          if bme280Sensor then
