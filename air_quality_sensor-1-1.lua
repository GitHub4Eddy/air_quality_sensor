...
-- This QuickApp reads the PM2.5, PM10, Temperature, Humidity and AirPressure values directly from a sensor. 
...
function QuickApp:getValues() -- Get the values
  ...
  local n = 11
  for i=1,n do
    if jsonTable.sensordatavalues[i].value_type == "SDS_P1" or jsonTable.sensordatavalues[i].value_type == "PMS_P1" then
      data.pm10 = jsonTable.sensordatavalues[i].value
    elseif jsonTable.sensordatavalues[i].value_type == "SDS_P2" or jsonTable.sensordatavalues[i].value_type == "PMS_P2" then
      data.pm25 = jsonTable.sensordatavalues[i].value
    elseif jsonTable.sensordatavalues[i].value_type == "BME280_temperature" or jsonTable.sensordatavalues[i].value_type == "temperature" then
      data.temperature = jsonTable.sensordatavalues[i].value
    elseif jsonTable.sensordatavalues[i].value_type == "BME280_pressure" or jsonTable.sensordatavalues[i].value_type == "pressure" then
      data.airpressure = string.format("%.0f",tonumber(jsonTable.sensordatavalues[i].value)/100)
    elseif jsonTable.sensordatavalues[i].value_type == "BME280_humidity" or jsonTable.sensordatavalues[i].value_type == "humidity" then
